...
type ProxyServiceClient interface {
	ExecuteJob(ctx context.Context, in *ExecuteJobProxyRequest, opts ...grpc.CallOption) (*Void, error)
}
...
func (c *proxyServiceClient) ExecuteJob(ctx context.Context, in *ExecuteJobProxyRequest, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/sdk.spark.v1.ProxyService/ExecuteJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProxyServiceServer interface {
	ExecuteJob(context.Context, *ExecuteJobProxyRequest) (*Void, error)
}
...
func (UnimplementedProxyServiceServer) ExecuteJob(context.Context, *ExecuteJobProxyRequest) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecuteJob not implemented")
}
...
func _ProxyService_ExecuteJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteJobProxyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProxyServiceServer).ExecuteJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sdk.spark.v1.ProxyService/ExecuteJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProxyServiceServer).ExecuteJob(ctx, req.(*ExecuteJobProxyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProxyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sdk.spark.v1.ProxyService",
	HandlerType: (*ProxyServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ExecuteJob",
			Handler:    _ProxyService_ExecuteJob_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "azarc/sdk/spark/v1/spark.proto",
