...
func (m *MockVariableHandler) Get(arg0, arg1 string, arg2 ...string) (*spark_v1.Inputs, error) {
	m.ctrl.T.Helper()
...
func (m *MockVariableHandler) Set(arg0, arg1 string, arg2 ...*spark_v1.Variable) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
