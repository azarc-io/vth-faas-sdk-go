...
func (m *MockVariableHandler) Get(arg0 string) (*sdk_v1.Variable, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVariableHandlerMockRecorder) Get(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockVariableHandler)(nil).Get), arg0)
}

// Set mocks base method.
func (m *MockVariableHandler) Set(arg0 *sdk_v1.Variable) error {
	m.ctrl.T.Helper()
